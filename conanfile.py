...
class cmake_helper_utils_conan_project(ConanFile):
    name = "cmake_helper_utils"
    ...
    description = "modified `cmake_helper_utils` library"
    topics = ('c++')
    ...
    def package_info(self):
        #self.cpp_info.libs = ["cmake_helper_utils"]
        ...
        #  os.path.join("base", "third_party", "cmake_helper_utils"))
        #self.cpp_info.includedirs.append(
        #  os.path.join("base", "third_party", "cmake_helper_utils", "compat"))
